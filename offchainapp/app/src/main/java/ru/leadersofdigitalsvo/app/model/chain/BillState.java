...
public class BillState extends State {
    ...
    public static BillState createInstance(String billId, String accountId, String agreementId, int amount, String state) {
    ...
    public static byte[] serialize(BillState bill) {
